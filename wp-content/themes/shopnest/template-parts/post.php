...
<head>
    ...
    <meta name="author" content="https://youtube.com/smhasib">
...
<body>
    ...
    <div class="main-wrapper">
        ...
        <article class="content px-3 py-5 p-md-5">
            <div class="container">
                <header class="content-header">
                    <div class="meta mb-3"><span class="date">Published 3 months ago</span><span class="tag"><i
                                class='fa fa-tag'></i> tag</span><span class="tag"><i class='fa fa-tag'></i>
                                    ...
                                    <footer class="comment-meta">
                                        <div class="comment-author vcard">
                                            <a href="https://wordpress.org/" rel="external nofollow" class="url"><img
                                                    ...
                                                    class="says sr-only">says:</span></a>
                                        </div>
                                        <!-- .comment-author -->
                                        ...
                                        <footer class="comment-meta">
                                            <div class="comment-author vcard">
                                                <img alt=""
                                                    ...
                                                    class="avatar avatar-120 photo" height="120" width="120"><span
                                                    class="fn">andrew</span><span class="says sr-only">says:</span>
                                            </div>
                                            <!-- .comment-author -->
        ...
        <footer class="footer text-center py-2 theme-bg-dark">
            ...
            <p class="copyright"><a href="https://youtube.com/smhasib">smhasib</a></p>
